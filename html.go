            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    <table>
                        ...
                        <tr>
                            <td>
                                <button class="btn btn-info upgrate" onclick="updata()">升级</button>
                            </td>
                        </tr>
                    </table>
...
<div class="waittingPage hidden">
    <span class="promptInfo">正在上传更新固件中，请稍后....</span>
